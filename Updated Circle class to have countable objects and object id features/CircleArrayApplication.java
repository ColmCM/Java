...
public class CircleArrayApplication
{
    public static void main(String []args){
       ...
       for (int i=0;i<myCircles.length;i++){
        ...
        int idNumber = myCircles[8].getId();
        System.out.println("The id number of this object is : " + idNumber);
        
        Circle joe = new Circle(5,5); // create a new object 
        
        System.out.println("The number of circles created is : " + Circle.circleCounter);
    } // end of main
